 ...
 * @author wrj
 */
public class WfUicUserKuduOperationsProducer implements KuduOperationsProducer {

    private static final String quote = "\t";
    private static final Logger logger = LoggerFactory.getLogger(WfUicUserKuduOperationsProducer.class);
    ...
    public WfUicUserKuduOperationsProducer() {
    }
...
//            WfUser people = gson.fromJson(raw, WfUser.class);
//            jsonMap = people.getData();
            UicUser people = gson.fromJson(raw, UicUser.class);
            UserDAO dao = people.getData();
//            User u = new User();
            jsonMap.put("invitation_code", "" + dao.getInvitation_code());
            jsonMap.put("login_channel_id", "" + dao.getLast_login_channel_id());
            jsonMap.put("name", "" + dao.getNickname());
            jsonMap.put("reg_channel_id", "" + dao.getReg_channel_id());
            jsonMap.put("reg_parent_channel", "" + dao.getReg_parent_channel());
            jsonMap.put("signup_time", "" + dao.getCreate_time());
            jsonMap.put("source_nickname", "" + dao.getSource_nickname());
            jsonMap.put("third_id", "" + dao.getThird_id());
            jsonMap.put("user_id", "" + dao.getId());
            jsonMap.put("user_source", "" + dao.getUser_source());
            jsonMap.put("user_status", "" + dao.getStatus());
            jsonMap.put("insert_uuid", "" + dao.getLoginname());
